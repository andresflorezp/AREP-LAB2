...
//"      <a href = \"http://localhost:9999/results\" target = \"_self\">Ver Resultados</a>\n" +  
	...
	*/
	private static String resultsPage(Request req, Response res) {
		 ...
		 * 
		 * set_1 = calculator.readInput(set1); set_1_mean = calculator.media(set_1);
		 * set_1_StdDev = calculator.desEstandar(set_1);
		 * 
		 * set_2 = calculator.readInput(set2); set_2_mean = calculator.media(set_2);
		 * set_2_StdDev = calculator.desEstandar(set_2);
		 * 
		 * System.out.println("SET 1:"); System.out.println("Mean: "+ set_1_mean);
		 * System.out.println("Standar Deviation: "+ set_1_StdDev);
		 * 
		 * System.out.println("SET 2:"); System.out.println("Mean: "+ set_2_mean);
		 * System.out.println("Standar Deviation: "+ set_2_StdDev);
		 */

		String resultsHTML = "<!DOCTYPE html>\n" + "<html>\n" + "   \n" + "   <head>\n"
				+ "      <title>Calculos Estadisticos</title>\n" + "   <style>" + "       table, th, td {"
				+ "           border: 1px solid black;" + "           border-colapse: collapse;" + "       }"
				+ "       th, td {" + "           padding: 5px;" + "       }" + "       th {"
